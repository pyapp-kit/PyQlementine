...
try:
    from PySide6.QAxContainer import QAxWidget
except ImportError:
...
def features_string(dock_widget: QtAds.CDockWidget) -> str:
    ...
    closable = f.value & QtAds.CDockWidget.DockWidgetFeature.DockWidgetClosable.value
    movable = f.value & QtAds.CDockWidget.DockWidgetFeature.DockWidgetMovable.value
    floatable = f.value & QtAds.CDockWidget.DockWidgetFeature.DockWidgetFloatable.value
...
class CCustomComponentsFactory(QtAds.CDockComponentsFactory):
    ...
    def createDockAreaTitleBar(self, dock_area: QtAds.CDockAreaWidget) -> QtAds.CDockAreaTitleBar:
        print("CCustomComponentsFactory::createDockAreaTitleBar")
        title_bar = QtAds.CDockAreaTitleBar(dock_area)
        custom_button = QToolButton(dock_area)
        custom_button.setToolTip("Help")
        custom_button.setIcon(svg_icon("images/help_outline.svg"))
...
class MainWindow(MainWindowUI, MainWindowBase):
    ...
    def __init__(self, parent=None):
        ...
        self.perspective_combo_box.activated.connect(self.dock_manager.openPerspective)
        
        self.create_content()
        # Default window geometry - center on screen
        self.resize(1280, 720)
        self.setGeometry(QStyle.alignedRect(
            Qt.LayoutDirection.LeftToRight, Qt.AlignmentFlag.AlignCenter, self.frameSize(),
    ...
    def create_content(self):
        ...
        dock_widget.setFeature(QtAds.CDockWidget.DockWidgetFeature.DockWidgetClosable, False)
        special_dock_area = self.dock_manager.addDockWidget(QtAds.DockWidgetArea.LeftDockWidgetArea, dock_widget)
        ...
        special_dock_area.setAllowedAreas(QtAds.DockWidgetArea.OuterDockAreas)
        ...
        dock_widget.setFeature(QtAds.CDockWidget.DockWidgetFeature.DockWidgetFocusable, False)
        self.dock_manager.addDockWidget(QtAds.DockWidgetArea.LeftDockWidgetArea, dock_widget)
        ...
        file_system_widget.setFeature(QtAds.CDockWidget.DockWidgetFeature.DockWidgetFloatable, False)
        append_feature_string_to_window_title(file_system_widget)
        self.dock_manager.addDockWidget(QtAds.DockWidgetArea.BottomDockWidgetArea, file_system_widget)
        
        file_system_widget = self.create_file_system_tree_dock_widget()
        file_system_widget.setFeature(QtAds.CDockWidget.DockWidgetFeature.DockWidgetMovable, False)
        file_system_widget.setFeature(QtAds.CDockWidget.DockWidgetFeature.DockWidgetFloatable, False)
        append_feature_string_to_window_title(file_system_widget)
        
        # Test custom factory - we inject a help button into the title bar
        QtAds.CDockComponentsFactory.setFactory(CCustomComponentsFactory())
        top_dock_area = self.dock_manager.addDockWidget(QtAds.DockWidgetArea.TopDockWidgetArea, file_system_widget)
        ...
        dock_area = self.dock_manager.addDockWidget(QtAds.DockWidgetArea.CenterDockWidgetArea, dock_widget, top_dock_area)
        ...
        custom_button.setIcon(svg_icon("images/plus.svg"))
        custom_button.setAutoRaise(True)
        ...
        def on_button_clicked():
            ...
            dock_widget.setFeature(QtAds.CDockWidget.DockWidgetFeature.DockWidgetDeleteOnClose, True)
        ...
        #     if flags & QtAds.CDockManager.eConfigParam.OpaqueUndocking:
        #         self.dock_manager.addDockWidget(QtAds.DockWidgetArea.CenterDockWidgetArea,
    ...
    def create_actions(self):
        ...
        self.actionSaveState.setIcon(svg_icon("images/save.svg"))
        self.toolBar.addAction(self.actionRestoreState)
        self.actionRestoreState.setIcon(svg_icon("images/restore.svg"))
        
        self.save_perspective_action = QAction("Create Perspective", self)
        self.save_perspective_action.setIcon(svg_icon("images/picture_in_picture.svg"))
        ...
        self.perspective_combo_box.setSizeAdjustPolicy(QComboBox.SizeAdjustPolicy.AdjustToContents)
        self.perspective_combo_box.setSizePolicy(QSizePolicy.Policy.Preferred, QSizePolicy.Policy.Preferred)
        ...
        a.setIcon(svg_icon("images/note_add.svg"))
        ...
        a.setIcon(svg_icon("images/docked_editor.svg"))
        a.triggered.connect(self.create_editor)
        self.menuTests.addAction(a)

        a = self.toolBar.addAction("Create Floating Table")
        a.setToolTip("Creates floating dynamic dockable table with millions of entries")
        a.setIcon(svg_icon("images/grid_on.svg"))
    ...
    def create_editor(self):
        ...
        dock_widget = self.create_editor_widget()
        dock_widget.setFeature(QtAds.CDockWidget.DockWidgetFeature.DockWidgetDeleteOnClose, True)
        dock_widget.setFeature(QtAds.CDockWidget.DockWidgetFeature.DockWidgetForceCloseWithArea, True)
        dock_widget.closeRequested.connect(self.on_editor_close_requested)
        ...
        if floating:
            ...
            if editor_area is not None:
                self.dock_manager.setConfigFlag(QtAds.CDockManager.eAutoHideFlag.EqualSplitOnInsertion, True)
                self.dock_manager.addDockWidget(QtAds.DockWidgetArea.RightDockWidgetArea, dock_widget, editor_area)
            else:
    ...
    def create_calendar_dock_widget(self) -> QtAds.CDockWidget:
        ...
        dock_widget.setToggleViewActionMode(QtAds.CDockWidget.eToggleViewActionMode.ActionModeShow)
        dock_widget.setIcon(svg_icon("images/date_range.svg"))
        self.menuView.addAction(dock_widget.toggleViewAction())
        return dock_widget
    ...
    def create_editor_widget(self) -> QtAds.CDockWidget:
        ...
        dock_widget.setWidget(widget)
        dock_widget.setIcon(svg_icon("images/edit.svg"))
        dock_widget.setFeature(QtAds.CDockWidget.DockWidgetFeature.CustomCloseHandling, True)
        self.menuView.addAction(dock_widget.toggleViewAction())

        options_menu = QMenu(dock_widget)
        options_menu.setTitle("Options")
        options_menu.setToolTip(options_menu.title())
        options_menu.setIcon(svg_icon("images/custom-menu-button.svg"))
    ...
    def create_table_widget(self) -> QtAds.CDockWidget:
        ...
        dock_widget.setWidget(widget)
        dock_widget.setIcon(svg_icon("images/grid_on.svg"))
        dock_widget.setMinimumSizeHintMode(QtAds.CDockWidget.eMinimumSizeHintMode.MinimumSizeHintFromContent)
        toolbar = dock_widget.createDefaultToolBar()
        action = toolbar.addAction(svg_icon("images/fullscreen.svg"), "Toggle Fullscreen")
...
def my_message_output(type: QtMsgType, context: QMessageLogContext, msg: str | None):
